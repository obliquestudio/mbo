...
// ## Log
// Function for logging gulpfile details to the console
gulp.task('log', function() {
    return gutil.log(globs.images);
});
...
gulp.task('styles', ['wiredep'], function() {
    ...
    return merged
        .pipe(writeToManifest('assets/css'));
});

// ### Modernizr
// Gulp task that scans input source for modernizr
// dependencies and then builds a custom version
gulp.task('modernizr', function() {
    gulp.src(path.source + 'assets/js/*.js')
        .pipe(modernizr({
            options: [
                'domPrefixes',
                'prefixes',
...
gulp.task('scripts', ['jshint'], function() {
    ...
    return merged
        .pipe(writeToManifest('assets/js'));
});
...
gulp.task('watch', function() {
    ...
    gulp.watch([path.source + 'assets/img/**/*'], ['images']);
    gulp.watch([path.source + '/**/*', '!' + path.source + '/assets{,/**}'], ['files']);
...
gulp.task('wiredep', function() {
    ...
    return gulp.src(project.css)
        .pipe(wiredep())
        .pipe(changed(path.source + 'assets/scss', {
            hasChanged: changed.compareSha1Digest
        }))
        .pipe(gulp.dest(path.source + 'assets/scss'));
});
