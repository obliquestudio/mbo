<?php
    ...
    /**
    *  ReduxFramework Oblique Studio Default Config
        ...
        *
        ...
        public function setSections() {
            ...
            * Used within different fields. Simply examples. Search for ACTUAL DECLARATION for field examples
            ...
            $this->sections[] = array(
                ...
                'desc' => __('<p class="description">Please fill in your social network details below.</p>', 'redux-framework'),
                'icon' => 'el-icon-bullhorn',
                'fields' => array(
                    array(
                        'id'=>'facebook_link',
                        'type' => 'text',
                        'title' => __('Facebook url', 'redux-framework'),
                        'subtitle' => __('Please enter the link to your Facebook page.', 'redux-framework'),
                        'validate' => 'url'
                    ),
                    array(
                        'id'=>'twitter_link',
                        'type' => 'text',
                        'title' => __('Twitter url', 'redux-framework'),
                        'subtitle' => __('Please enter the link to your Twitter profile.', 'redux-framework'),
                        'validate' => 'url'
                    ),
                    array(
                        'id'=>'pinterest_link',
                        'type' => 'text',
                        'title' => __('Pinterest url', 'redux-framework'),
                        'subtitle' => __('Please enter the link to your Pinterest page.', 'redux-framework'),
                        'validate' => 'url'
                    ),
                )
            );
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'mbo_options',            // This is where your data is stored in the database and also becomes your global variable name.
